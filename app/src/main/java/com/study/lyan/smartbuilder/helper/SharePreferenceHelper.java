...
public class SharePreferenceHelper {
    ...
    private static class SingleTon {
        public static SharePreferenceHelper instance = new SharePreferenceHelper();
    }
    ...
    public static SharePreferenceHelper getInstance() {
        return SharePreferenceHelper.SingleTon.instance;
    }
     ...
     * @return
     */
    public SharePreferenceHelper put(String key, Object values) {
     ...
     * @return
     */
    public SharePreferenceHelper remove(String key) {
        editor.remove(key);
        return this;
    }
     ...
     * @returnll
     */
    public SharePreferenceHelper removeAll() {
        editor.clear();
        return this;
    }
